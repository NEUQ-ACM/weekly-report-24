...
public class WeeklyChecker
{
    ...
    {
        val projectPath = "E:\\ACodeSpace\\Stream-NEUQ-ACM-weekly-report-24";
    ...
    private static void checkWeek(String studentName, List<File> week) throws WeekNotQualifiedException
    {
        ...
        if(week.stream().flatMap(WeeklyChecker::expandRecursively).noneMatch(f -> f.getName().contains(".java")))
        {
            messageList.add(studentName + "本周demo项目未完成");
        }
